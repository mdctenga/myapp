...
describe('Chat Module', function () {
	...
	it('should create directory if none exist', function () {
	...
	it('should create a new JSON if Chatroom does not exist', function () {
	...
	it('should get all messages from a specific user', function () {
	...
	it('should get a user\'s messages from all chatrooms', function () {
		...
		//Make it so this test can see the temp file that
		fs.unlinkSync( path.resolve('./test/data/tmpchatroom.json') );
	});
});